      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Оставьте заявку — и мы расскажем, как подключить вашу организацию к платформе «Бумеранг»
              и начать реализацию социальных проектов.
            </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-foreground">Вся Россия</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Расскажите об организации и цели участия..."
                  required
                />
              </div>
              <button
